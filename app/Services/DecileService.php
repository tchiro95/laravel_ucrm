...
class DecileService
{
    public static function Decile($subQuery)
    {
        ...
        // $subQueryで繋ぐ。クエリビルダは実行しないでクエリを貯めていくので、以下は段々と積み重ねてget()を待つ状態になってる。
        // だから、各項目で$subQueryが出てくる。
        // これが、「クエリビルダ」だ
        //購買IDごとにまとめる
        ...
        // DB::tableは()で指定されたテーブルのクエリビルダを作成する。ここでは$subQueryを含んだクエリビルダ（SQLの実行文の組み立て）を作成している。
